...
export const CLOSE_UNREVEALED_VOUCH_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  192, 236, 224, 245, 5, 49, 188, 11,
]);

export function getCloseUnrevealedVouchAccountDiscriminatorBytes() {
...
export type CloseUnrevealedVouchAccountInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type CloseUnrevealedVouchAccountInstructionDataArgs = {};

export function getCloseUnrevealedVouchAccountInstructionDataEncoder(): FixedSizeEncoder<CloseUnrevealedVouchAccountInstructionDataArgs> {
...
export function getCloseUnrevealedVouchAccountInstructionDataDecoder(): FixedSizeDecoder<CloseUnrevealedVouchAccountInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getCloseUnrevealedVouchAccountInstructionDataCodec(): FixedSizeCodec<
  CloseUnrevealedVouchAccountInstructionDataArgs,
  CloseUnrevealedVouchAccountInstructionData
> {
  return combineCodec(
...
export type ParsedCloseUnrevealedVouchAccountInstruction<
  TProgram extends string = typeof OPPORTUNITY_MARKET_PROGRAM_ADDRESS,
...
export function parseCloseUnrevealedVouchAccountInstruction<
