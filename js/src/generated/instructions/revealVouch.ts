...
export const REVEAL_VOUCH_DISCRIMINATOR = new Uint8Array([
  137, 238, 214, 30, 51, 142, 141, 105,
]);

export function getRevealVouchDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REVEAL_VOUCH_DISCRIMINATOR
  );
}

export type RevealVouchInstruction<
...
export type RevealVouchInstructionData = {
  discriminator: ReadonlyUint8Array;
  computationOffset: bigint;
  vouchAccountId: number;
};

export type RevealVouchInstructionDataArgs = {
  computationOffset: number | bigint;
  vouchAccountId: number;
};

export function getRevealVouchInstructionDataEncoder(): FixedSizeEncoder<RevealVouchInstructionDataArgs> {
...
export function getRevealVouchInstructionDataDecoder(): FixedSizeDecoder<RevealVouchInstructionData> {
...
export function getRevealVouchInstructionDataCodec(): FixedSizeCodec<
  RevealVouchInstructionDataArgs,
  RevealVouchInstructionData
> {
  return combineCodec(
...
export type RevealVouchAsyncInput<
...
export async function getRevealVouchInstructionAsync<
  TAccountSigner extends string,
  TAccountOwner extends string,
  TAccountMarket extends string,
  TAccountVouchAccount extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRevealVouchInstructionDataEncoder().encode(
      args as RevealVouchInstructionDataArgs
    ),
    programAddress,
  } as RevealVouchInstruction<
    TProgramAddress,
    TAccountSigner,
    TAccountOwner,
    TAccountMarket,
...
export function getRevealVouchInstruction<
  TAccountSigner extends string,
  TAccountOwner extends string,
  TAccountMarket extends string,
  TAccountVouchAccount extends string,
...
export type ParsedRevealVouchInstruction<
  TProgram extends string = typeof OPPORTUNITY_MARKET_PROGRAM_ADDRESS,
...
export function parseRevealVouchInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevealVouchInstruction<TProgram, TAccountMetas> {
