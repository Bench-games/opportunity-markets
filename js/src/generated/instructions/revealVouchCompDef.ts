...
export const REVEAL_VOUCH_COMP_DEF_DISCRIMINATOR = new Uint8Array([
  176, 228, 5, 47, 19, 6, 243, 236,
]);

export function getRevealVouchCompDefDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REVEAL_VOUCH_COMP_DEF_DISCRIMINATOR
  );
}

export type RevealVouchCompDefInstruction<
...
export type RevealVouchCompDefInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type RevealVouchCompDefInstructionDataArgs = {};

export function getRevealVouchCompDefInstructionDataEncoder(): FixedSizeEncoder<RevealVouchCompDefInstructionDataArgs> {
...
export function getRevealVouchCompDefInstructionDataDecoder(): FixedSizeDecoder<RevealVouchCompDefInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getRevealVouchCompDefInstructionDataCodec(): FixedSizeCodec<
  RevealVouchCompDefInstructionDataArgs,
  RevealVouchCompDefInstructionData
> {
  return combineCodec(
...
export type RevealVouchCompDefInput<
...
export function getRevealVouchCompDefInstruction<
  TAccountPayer extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
  TAccountAddressLookupTable extends string,
...
> {
  ...
  return Object.freeze({
    ...
    programAddress,
  } as RevealVouchCompDefInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountMxeAccount,
    TAccountCompDefAccount,
...
export type ParsedRevealVouchCompDefInstruction<
  TProgram extends string = typeof OPPORTUNITY_MARKET_PROGRAM_ADDRESS,
...
export function parseRevealVouchCompDefInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevealVouchCompDefInstruction<TProgram, TAccountMetas> {
