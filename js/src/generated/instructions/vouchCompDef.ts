...
export const VOUCH_COMP_DEF_DISCRIMINATOR = new Uint8Array([
  138, 27, 95, 181, 9, 219, 232, 219,
]);

export function getVouchCompDefDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    VOUCH_COMP_DEF_DISCRIMINATOR
  );
}

export type VouchCompDefInstruction<
...
export type VouchCompDefInstructionData = { discriminator: ReadonlyUint8Array };

export type VouchCompDefInstructionDataArgs = {};

export function getVouchCompDefInstructionDataEncoder(): FixedSizeEncoder<VouchCompDefInstructionDataArgs> {
...
export function getVouchCompDefInstructionDataDecoder(): FixedSizeDecoder<VouchCompDefInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getVouchCompDefInstructionDataCodec(): FixedSizeCodec<
  VouchCompDefInstructionDataArgs,
  VouchCompDefInstructionData
> {
  return combineCodec(
...
export function getVouchCompDefInstruction<
  TAccountPayer extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
  TAccountAddressLookupTable extends string,
...
export type ParsedVouchCompDefInstruction<
  TProgram extends string = typeof OPPORTUNITY_MARKET_PROGRAM_ADDRESS,
...
export function parseVouchCompDefInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedVouchCompDefInstruction<TProgram, TAccountMetas> {
